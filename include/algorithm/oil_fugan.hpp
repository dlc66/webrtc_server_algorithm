...
public:
    YOLOv5(const std::string& enginePath, cv::Size inputSize);
      std::vector<std::string> classNames = {
       "2", "2.5", "3", "3.5", "4", "4.5", "5", "5.5", "6", "6.5", "7", "7.5", "8", "8.5", "9", "9.5", "10", "rline"
    };
...
void YOLOv5::drawAndSaveResults(cv::Mat& img, const std::vector<Object>& objects,std::string& pos,float& conf,std::string& desc) {

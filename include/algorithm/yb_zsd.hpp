...
class YbZsdClassifier {
public:
    YbZsdClassifier(const std::string& engine_file_path);
    ~YbZsdClassifier();
...
YbZsdClassifier::YbZsdClassifier(const std::string& engine_file_path)
...
YbZsdClassifier::~YbZsdClassifier() {
...
cv::Mat YbZsdClassifier::preprocess(const cv::Mat& image) {
...
std::pair<std::string, float> YbZsdClassifier::infer(const cv::Mat& input_image) {
